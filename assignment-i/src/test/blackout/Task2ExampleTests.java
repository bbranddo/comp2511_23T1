...
public class Task2ExampleTests {
    ...
    @Test
    public void testStandardSatelliteDoesNotSupportDesktop() {
        BlackoutController controller = new BlackoutController();
        controller.createSatellite("Satellite1", "StandardSatellite", 1000 + RADIUS_OF_JUPITER, Angle.fromDegrees(315));
        controller.createDevice("DeviceA", "DesktopDevice", Angle.fromDegrees(320));
        controller.createDevice("DeviceB", "LaptopDevice", Angle.fromDegrees(310));
    ...
    @Test
    public void testRelayMovementTowards140() {
        // Task 2
        // Example from the specification
        BlackoutController controller = new BlackoutController();
    ...
    @Test
    public void testRelayMovementTowards190() {
        // Task 2
        // Example from the specification
        BlackoutController controller = new BlackoutController();
        ...
        assertEquals(new EntityInfoResponse("Satellite1", Angle.fromDegrees(189.82), 100 + RADIUS_OF_JUPITER,
                "RelaySatellite"), controller.getInfo("Satellite1"));
        // edge case
        controller.simulate(1);
        assertEquals(new EntityInfoResponse("Satellite1", Angle.fromDegrees(191.05), 100 + RADIUS_OF_JUPITER,
                "RelaySatellite"), controller.getInfo("Satellite1"));
        // coming back
        controller.simulate(1);
        assertEquals(new EntityInfoResponse("Satellite1", Angle.fromDegrees(189.82), 100 + RADIUS_OF_JUPITER,
    ...
    @Test
    public void getInfoTeleportingSatellite() {
        BlackoutController controller = new BlackoutController();
    ...
    @Test
    public void getInfoRelaySatellite() {
        BlackoutController controller = new BlackoutController();

        controller.createSatellite("Satellite1", "RelaySatellite", 10000 + RADIUS_OF_JUPITER, Angle.fromDegrees(0));

        // controller.getInfo("Satellite1");

        assertEquals(
                new EntityInfoResponse("Satellite1", Angle.fromDegrees(0), 10000 + RADIUS_OF_JUPITER, "RelaySatellite"),
                controller.getInfo("Satellite1"));
    }
}
